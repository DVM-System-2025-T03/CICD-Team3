...
void to_json(json& j, const Msg_content_RequestPrePaymentDTO& mc) {
    j = json{{"item_code", mc.item_code}, {"item_num", mc.item_num}, {"cert_code", mc.cert_code}};
}

void from_json(const json& j, Msg_content_RequestPrePaymentDTO& mc) {
    j.at("item_code").get_to(mc.item_code);
    j.at("item_num").get_to(mc.item_num);
    j.at("cert_code").get_to(mc.cert_code);
}

void to_json(json& j, const RequestPrePaymentDTO& dto) {
    j = json{
...
void from_json(const json& j, RequestPrePaymentDTO& dto) {
